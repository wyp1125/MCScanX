...
if(args.length<8)
{
System.out.println("Usage: java dual_synteny_plotter -g gff_file -s collinearity_file -c control_file -o output_PNG_file");
System.exit(1);
}
...
dual_synteny_plotter proc=new dual_synteny_plotter();

...
public class syntenic_dot_plotter{
Hashtable gene_feat;
Hashtable chr_len;
...
if(args.length<8)
{
System.out.println("Usage: java syntenic_block_table -g gff_file -s synteny_file -c control_file -o output_jpeg_file");
System.exit(1);
}
...
syntenic_dot_plotter proc=new syntenic_dot_plotter();
